{
    ...
    config: [
        ...
        name: "acueducto",
        type: "text",
        description: "Digite si el inmueble cuenta con acueducto",
        },
        {
        name: "energia",
        type: "text",
        description: "Digite si el inmueble cuenta con energia",
        },
        {
        name: "gas",
        type: "text",
        description: "Digite si el inmueble cuenta con gas",
        },
        {
        name: "linea",
        type: "text",
        description: "Digite si el inmueble cuenta con linea telefonica",
        },
        {
        name: "tv",
        type: "text",
        description: "Digite si el inmueble cuenta con tv",
        },
        {
        name: "administracion",
        type: "text",
        description: "Digite si el inmueble cuenta con administracion",
        },
        {
        name: "otros",
        type: "text",
